    ...
    <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl backdrop-blur-sm">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-2 border-dashed border-slate-700 rounded-xl p-4 text-center cursor-pointer hover:border-green-500 hover:bg-slate-800/50 transition-all duration-300">
          ...
          >
            {preview ? (
              <img
                src={preview}
                className="h-32 w-32 object-cover rounded-lg shadow-lg border border-slate-700"
                alt="preview"
              />
            ) : (
        ...
        <button
          disabled={loading}
          type="submit"
          className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white font-bold py-4 rounded-xl transition duration-300 shadow-lg shadow-green-900/20 disabled:opacity-50 cursor-pointer"
        >
