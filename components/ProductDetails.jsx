                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-600 leading-relaxed text-lg">
                                বাংলার ঐতিহ্য আর ঘ্রাণের অনন্য সংমিশ্রণ – পরিচয় করিয়ে দিচ্ছি "ইলিশ মাছের আচার"। শতভাগ দেশি উপকরণ আর ঘরের রান্নার স্বাদে প্রস্তুত এই আচার আপনাকে ফিরিয়ে নিয়ে যাবে মায়ের হাতের সেই পুরনো দিনে।
                            </p>

                            <div className="space-y-4 pt-2">
                                <div className="flex items-center gap-3">
                                    <span className="text-xl">🔒</span>
                                    <span className="text-gray-700 font-medium">১০০% হাইজেনিক ও নিরাপদ</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <span className="text-xl">🏠</span>
                                    <span className="text-gray-700 font-medium">হোমমেড রেসিপি</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <span className="text-xl">✨</span>
                                    <span className="text-gray-700 font-medium">প্রিজারভেটিভ মুক্ত</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-6 pt-6">
                                <div className="text-left">
                                    <p className="text-sm text-gray-500 uppercase tracking-wide">মূল্য</p>
                                    <p className="text-3xl font-bold text-green-700">৳১০০০</p>
                                </div>
                                <div className="h-10 w-[1px] bg-gray-300"></div>
                                <div className="text-left">
                                    <p className="text-sm text-gray-500 uppercase tracking-wide">পরিমাণ</p>
                        ...
                        <div className="flex justify-center items-center">
                            <div className="relative w-full max-w-sm aspect-square bg-white rounded-3xl shadow-2xl p-4 transition-all duration-500 hover:shadow-green-200/50 border border-slate-100 flex flex-col justify-center items-center">
                                {/* প্রিমিয়াম ব্যাজ */}
                                <div className="absolute -top-4 -right-4 bg-yellow-400 text-yellow-900 px-4 py-2 rounded-full font-bold shadow-lg transform rotate-6 z-10">Premium</div>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="text-gray-800 font-bold text-lg">প্রিমিয়াম প্যাকেজ</p>
