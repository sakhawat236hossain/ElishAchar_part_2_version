  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        setError(
          err.message || "প্রোডাক্ট লোড করতে সমস্যা হয়েছে। পরে চেষ্টা করুন।",
        );
      } finally {
        setLoading(false);
      }
      ...
      <section className="w-full py-12 px-4 md:px-8 bg-gray-50 flex flex-col items-center justify-center">
        <div className="max-w-7xl mx-auto text-center py-20 flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600 text-center">
            এই মুহূর্তে কোন প্রোডাক্ট উপলব্ধ নেই
          </p>
        </div>
      </section>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-between gap-6 mb-10 md:flex-row md:items-end">
          ...
          <div className="flex gap-2">
            <button className="prev-btn p-3 bg-white border border-gray-300 hover:bg-green-600 hover:text-white rounded-full transition-all duration-300 shadow-sm cursor-pointer">
              &lt;
            </button>
            <button className="next-btn p-3 bg-white border border-gray-300 hover:bg-green-600 hover:text-white rounded-full transition-all duration-300 shadow-sm cursor-pointer">
              &gt;
            </button>
          </div>
        </div>
