					...
					<div className="flex justify-center items-center">
						<div className="relative w-full max-w-sm aspect-square bg-white rounded-3xl shadow-2xl p-4 transition-all duration-500 hover:shadow-green-200/50">
							<div className="relative w-full h-full overflow-hidden rounded-2xl">
								<Image src="/hero.jpg" fill alt="ইলিশ মাছের আচার" className="object-cover transition-transform duration-700 hover:scale-110" />
							</div>
							{/* Badge */}
							<div className="absolute -top-4 -right-4 bg-green-600 text-white px-4 py-2 rounded-full font-bold shadow-lg transform rotate-6">সেরা স্বাদ!</div>
						</div>
					</div>
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20 pt-10 border-t border-gray-200">
					{[
						...
						<div key={i} className="text-center group">
							<p className="text-2xl md:text-3xl font-bold text-gray-900 group-hover:text-green-600 transition-colors">{stat.value}</p>
