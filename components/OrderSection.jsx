		...
		<section className="w-full py-12 md:py-16 px-4 md:px-8 bg-gradient-to-r from-green-50 to-emerald-50">
			<div className="max-w-4xl mx-auto">
				<div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
					<h2 className="text-2xl md:text-3xl font-bold text-center text-gray-900 mb-8">📦 অর্ডার করুন এখনই!</h2>

					<div className="space-y-6">
						{/* Call to Action */}
						<div className="bg-green-50 border-2 border-green-600 rounded-lg p-6 text-center">
							<p className="text-gray-900 font-bold mb-4 text-lg">👉 অর্ডার করতে নিচে ক্লিক করুন</p>
							<a
								href="#best-selling"
